  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block overflow-hidden text-left align-bottom transition-all transform bg-card rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
          <div className="px-4 pt-5 pb-4 bg-card sm:p-6 sm:pb-4">
            ...
            {loading ? (
              ...
              <div className="py-12 text-center">
                <p className="text-text-secondary">{t('invoices.details.not_found', 'Invoice not found')}</p>
              </div>
            ) : (
                ...
                <div className="lg:col-span-2">
                  <div className="flex flex-col sm:flex-row justify-between gap-6 mb-8">
                    ...
                    <div className="text-right">
                      <span className={`inline-flex px-3 py-1 text-sm font-semibold rounded-full ${(invoice.status || '').toUpperCase() === 'PAID'
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                      ...
                      {invoice.customer ? (
                        <div className="space-y-1">
                          ...
                          {invoice.customer.contact && (
                            <div className="text-text-secondary">{invoice.customer.contact}</div>
                          )}
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        <div className="font-medium text-text-primary">DAI TRADING W.L.L</div>
                        <div className="text-sm text-text-secondary font-arabic">ضي للتجارة ذ.م.م</div>
                        <div className="text-text-secondary text-sm">OFFICE 2, BUILDING 55, STREET 3098, ZONE 91</div>
                        <div className="text-text-secondary text-sm">Doha, Qatar</div>
                        <div className="text-text-secondary text-sm">C.R: 116392 | TEL: 3000 8935</div>
                        <div className="text-text-secondary text-sm">daitrading@gmail.com</div>
                        <div className="text-text-secondary text-xs mt-2 pt-2 border-t border-theme-border">
                          IBAN: QA13QISB000000000152390820012 (QIB)
                        </div>
                      </div>
                    </div>
                  </div>
                          ...
                          {(invoice.items || invoice.InvoiceItem || []).map((item, index) => {
                            ...
                            return (
                              <tr key={index}>
                                ...
                                <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-text-primary text-right">
                  ...
                  <div className="max-w-xs ml-auto">
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-text-secondary">{t('invoices.details.subtotal', 'Subtotal')}</span>
                      ...
                      {(invoice.total_discount || invoice.discount || 0) > 0 && (
                        <div className="flex justify-between">
                          <span className="text-text-secondary">{t('invoices.details.discount', 'Discount')}</span>
                      ...
                      <div className="flex justify-between pt-2 border-t border-theme-border">
                        <span className="text-text-primary font-medium">{t('invoices.details.total', 'Total')}</span>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="text-sm text-text-secondary">{t('invoices.details.payment_mode', 'Payment Mode')}</p>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="text-sm text-text-secondary">{t('invoices.details.reference', 'Reference')}</p>
                            <p className="text-sm font-medium text-text-primary">
