            ...
            <div className="p-6 space-y-4">
              ...
              {selectedLog.old_values && (
                <div>
                  ...
                  <pre className="text-xs text-gray-900 bg-red-50 p-3 rounded-lg overflow-x-auto">
              ...
              {selectedLog.new_values && (
                <div>
                  ...
                  <pre className="text-xs text-gray-900 bg-green-50 p-3 rounded-lg overflow-x-auto">
