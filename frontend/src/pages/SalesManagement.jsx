    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage sales orders and transactions</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{Number(stats.total_sales || 0)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">QAR {(parseFloat(stats.total_revenue) || 0).toFixed(2)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Total Weight Sold</p>
              <p className="text-2xl font-bold text-gray-900">{(parseFloat(stats.total_weight_sold) || 0).toFixed(2)} kg</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">QAR {(parseFloat(stats.avg_unit_price) || 0).toFixed(2)}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{counts.products}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-lg p-6 shadow-sm border">
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{counts.warehouses}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{counts.suppliers}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border">
          ...
          <div className="p-6">
            {Object.keys(salesRevenueSummary.by_product || {}).length === 0 ? (
              <p className="text-sm text-gray-500">No product revenue data for selected filters.</p>
            ) : (
                ...
                {Object.values(salesRevenueSummary.by_product)
                  ...
                  .map((p) => (
                    <li key={p.product_id} className="flex items-center justify-between">
                      <span className="text-sm text-gray-700">{p.product_name_en || p.product_name_ar || `Product #${p.product_id}`}</span>
                      <span className="text-sm font-medium text-gray-900">QAR {(parseFloat(p.total_revenue) || 0).toFixed(2)}</span>
                    </li>
                  ))}
              </ul>
            )}
        ...
        <div className="bg-white rounded-lg shadow-sm border">
          ...
          <div className="p-6">
            {Object.keys(salesRevenueSummary.by_customer || {}).length === 0 ? (
              <p className="text-sm text-gray-500">No customer revenue data for selected filters.</p>
            ) : (
              <ul className="space-y-3">
                {Object.values(salesRevenueSummary.by_customer)
                  ...
                  .map((c) => (
                    <li key={c.customer_id} className="flex items-center justify-between">
                      <span className="text-sm text-gray-700">{c.customer_name || `Customer #${c.customer_id}`}</span>
                      <span className="text-sm font-medium text-gray-900">QAR {(parseFloat(c.total_revenue) || 0).toFixed(2)}</span>
                    </li>
                  ))}
              </ul>
            )}
      ...
      <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
        {sales.length === 0 ? (
          <div className="p-8 text-center">
            ...
            <p className="text-gray-500">Try adjusting filters or add a new sale.</p>
          </div>
        ) : (
          <>
                  ...
                  {sales.map((sale) => {
                    ...
                    return (
                      <tr key={sale.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{(parseFloat(sale.sold_weight) || 0).toFixed(2)} {unit}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">QAR {(parseFloat(sale.unit_price) || 0).toFixed(2)}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">QAR {(parseFloat(sale.total_amount) || 0).toFixed(2)}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{formatDate(sale.sale_date)}</td>
